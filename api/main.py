...
model =load_model('/coppeliasim-python/model_creation/models/Ai_Car-0.8709677457809448.h5')


dict_file = open("/coppeliasim-python/model_creation/Data/ai_car.pkl", "rb")
